...
jQuery.fn.keyboard = function(options){
	...
	var make = function(){
		...
		<div class="keyboard_norm keyboard_type en">\
			...
			<table class="keyboard_row">\
				<tr >\
					<td><span class="keyboard_key" style="font-size:10px; height:18px; color:blue"><span class="keyboard_key-m">Z</span></span></td>\
			...
			<table class="keyboard_row">\
				<tr >\
					<td><span class="keyboard_key" style="font-size:10px; height:18px; color:blue"><span class="keyboard_key-m"></span></span></td>\
					<td><span class="keyboard_key" style="font-size:10px; height:18px; color:blue"><span class="keyboard_key-m">U</span></span></td>\
					<td><span class="keyboard_key" style="font-size:10px; height:18px; color:blue"><span class="keyboard_key-m">&</span></span></td>\
					<td><span class="keyboard_key" style="font-size:10px; height:18px; color:blue"><span class="keyboard_key-m">,</span></span></td>\
